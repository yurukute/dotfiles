...
local ICON_DIR = os.getenv('HOME') .. '/.config/awesome/widgets/logout-menu-widget/icons/'
...
local function worker(user_args)
    ...
    local onlock = args.onlock or function() awful.spawn.with_shell('i3lock -c "#0f59d1"') end
