...
#+begin_src emacs-lisp
  (use-package popwin
    ...
    (push '("\\*g\\+\\+[-\\w ]+<\\d+>[-\\w ]+: \\w+\\*" :regexp t) popwin:special-display-config)
...
#+begin_src emacs-lisp  
  (dolist (face '(org-block
                  ...
                  org-special-keyword
                  org-verbatim))
    (set-face-attribute face nil :inherit 'fixed-pitch :height 1.1))
  (set-face-attribute 'org-table nil :inherit 'fixed-pitch :height 1.1 :foreground "#82D7FF" :family "Droid Sans Mono")
#+end_src