...
#+begin_src emacs-lisp
  (use-package popwin
    ...
    (push '("*arduino-upload*" :regexp t :stick t) popwin:special-display-config)
    (push '("*arduino-verify*" :regexp t) popwin:special-display-config)
    (popwin-mode 1))
#+end_src
...
#+begin_src emacs-lisp  
  ...
  (set-face-attribute 'org-table nil :inherit 'fixed-pitch :foreground "#82D7FF")
#+end_src
