...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load 'ediff
    (dolist (face '((ediff-even-diff-A . "brown")
                    (ediff-even-diff-B . "forest green")
                    (ediff-odd-diff-A . "dark red")
                    (ediff-odd-diff-B . "dark green")))
      (face-spec-set (car face) `((t (:background ,(cdr face) :foreground "white" :extend t))))))
#+end_src
